...
use WellFollowedBundle\Manager\Filter\InstitutionFilter;
use WellFollowedBundle\Model\Common\ListModel;
use WellFollowedBundle\Model\Institution\InstitutionListModel;
use WellFollowedBundle\Model\Institution\InstitutionModel;
...
class InstitutionManager
{
    ...
    public function  getInstitutions(InstitutionFilter $filter = null)
    {
        $qb = $this->entityManager
            ->getRepository('WellFollowedBundle:Institution')
    ...
    public function deleteInstitution($id)
    {
        ...
        if ($id > 0) {
            ...
            $qb->delete('WellFollowedBundle\Entity\Institution', 'i')
                ->where('i.id = :id')
                ->setParameter('id', $id);
